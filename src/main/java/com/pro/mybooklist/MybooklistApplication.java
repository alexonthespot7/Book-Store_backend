...
public class MybooklistApplication {
	...
	public CommandLineRunner runner() {
		return (args) -> {
			...
			orepository.save(new Order("Aleksei", "Shevelenkov", "Hungary", "Budapest", "Fronza 24 J 102", "22304", "shevelenkov.aa@edu.spbstu.ru", backet2Admin, "Make my order quick please", hashPwd));
		};
	}
}
